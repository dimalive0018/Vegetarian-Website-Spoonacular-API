    ...
    >
      <form onSubmit={submit}>
        <div className='flex items-center'>
          <input className='h-8 md:h-10 xl:h-12 w-42 md:w-64 xl:w-96 text-center border-2 md:border-4 border-[#608E43] rounded-l-xl rounded-tr-xl shadow-searchBar hover:opacity-90 active:scale-[0.95]' placeholder='Type of food intolerance' onChange={(event) => setSearch(event.target.value)} type="text" value={search} />
